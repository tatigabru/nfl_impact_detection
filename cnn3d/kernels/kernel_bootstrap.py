...
CHECKPOINT = ['201231_04_03_densenet121_video_fold0_A100_def/checkpoints_metrics_impact_f1_ppc/best.pth']
CLIP_LENGTH = 8
ACTIVATION_AFTER = 'after_model' # after_tta, after_ensemble
TTA_MODE = 'clips-fliplr'
USE_SLIDING_WINDOW = False
CLF_THRESH = 0.2
HELMET_THRESHOLD_SCORE = 0.5
IMPACT_THRESHOLD_SCORE = 0.05
...
def video_classificatoin_inference_main(
    ...
    for video_fname in videos:
        ...
        video_unique_ids, video_scores = run_inference_video_classification_tta(model,
                                                                            videodf,
                                                                            video_dir,
                                                                            video_fname,
                                                                            clip_length=16,
...
# Main
submission = joint_inference(run_detection=False, run_classification=True)
# os.remove('raw_predictions.csv')
